...
export default function Modal({ modalData }) {
  ...
  const { title, description, type, language, tools, country, url } = details;
  return (
          ...
          <div className="col-lg-5 pt-4 pt-lg-0">
            ...
            <div className="about-content">
              <ul>
                ...
                {language && (
                  <li className="d-flex">
                    <span className="col-4 col-lg-3">Tech Stack:</span>
                    <span>{language}</span>
                  </li>
                )}
                {tools && (
                  <li className="d-flex">
                    <span className="col-4 col-lg-3">Tools Design:</span>
                    <span>{tools}</span>
                  </li>
                )}
                {country && (
